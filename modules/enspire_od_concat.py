...
class DataConcat:
    ...
    def data_concat(self, enspire_df, od_df, standard_row):
        ...
        self.concat_data.loc[(self.concat_data["Well_Id"].apply(lambda x: x[:1]) == standard_row), "Sample_Type"] = "Standard"
    ...
    def display_data_concat(self, display_data, od_df, standard_row):
        ...
        self.concat_display.loc[(self.concat_display["Well_Id"].apply(lambda x: x[:1]) == standard_row), "Sample_Type"] = "Standard"
